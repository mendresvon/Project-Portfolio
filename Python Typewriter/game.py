...
level_screen = f'''{bright_magenta}               ▒█░░░ █▀▀ ▀█░█▀ █▀▀ █░░ █▀▀ ▄ 
     ...
     1: Say Hello!      7: For Loops         c: {bright_cyan}Cursor{reset}
    2: Variables            8: More Loops
     3: Try Addition!        9: Even More Loops
...
age = 18
looks = "cutie"
print(name, age, looks)''',
  3:'''num1 = int(input("Enter first number: "))
num2 = int(input("Enter second number: "))
sum = num1 + num2
print(sum)''',
  4:'''languages = ["Python", "Java", "JavaScript", "C"]
print(languages)''',
  5:'''languages = ("Python", "Java", "JavaScript", "C")
print(languages)''',
